...
```{r, echo = F}
# save(m0, file = "fits/m00.rda")
# save(m1, file = "fits/m01.rda")
# save(m2, file = "fits/m02.rda")
# save(m3, file = "fits/m03.rda")
# save(m4, file = "fits/m04.rda")
# save(m5, file = "fits/m05.rda")
# save(m6, file = "fits/m06.rda")
# save(m7, file = "fits/m07.rda")
# save(m8, file = "fits/m08.rda")
# save(m9, file = "fits/m09.rda")
...
ggsave("featured.jpg", width = 3.5, height = 3.5, units = "in")
```
